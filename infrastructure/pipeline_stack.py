...
class DjangoAppPipelineStack(Stack):
    def __init__(
            self,
            scope: Construct,
            construct_id: str,
            ...
            docker_credentials=[
                pipelines.DockerCredential.docker_hub(
                    secretsmanager.Secret.from_secret_name_v2(
                        self,
                        "DockerHubSecret",
                        secret_name="/DjangoAppPipeline/DockerHubSecret"
                    )
                ),
            ],
        ...
        self.staging_env = DjangoAppPipelineStage(
            self, "DjangoAppStaging",
        ...
        self.production_env = DjangoAppPipelineStage(
